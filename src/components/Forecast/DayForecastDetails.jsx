...
/**
 * Displays detailed forecast information for a specific day, including wave height, quality rating, swell direction, wind, and weather.
 *
 * @component
 * @param {Object} props - Component props.
 * @param {string} props.date - The date for which the forecast is displayed.
 * @param {Array<Object>} props.slots - Array of forecast slot objects for the day. Each slot should contain time, waveHeight, period, waveDirection, windSpeed, and airTemp.
 * @param {"ft"|"m"} [props.unit="ft"] - Unit for wave height display ("ft" for feet, "m" for meters).
 * @param {"C"|"F"} [props.tempUnit="C"] - Unit for temperature display ("C" for Celsius, "F" for Fahrenheit).
 * @returns {JSX.Element} The rendered forecast details table for the day.
 */
function DayForecastDetailsV2({ date, slots, unit = "ft", tempUnit = "C" }) {
  // Filter slots to include only those between 6:00 and 21:00 hours
                      ...
                      <div className="rating rating-sm">
                        {starRatings.map((stars) => (
                          <div
                            ...
                            //
                            aria-current={
                              waveQualityRating >= stars ? "true" : undefined
                            }
                          />
                        ))}
                      </div>
